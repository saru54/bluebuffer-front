<template>
    <div class="container">
        <div class="commentLikeInfo" v-for="(item, index) of data" :key="index">
            ...
            <!-- 评论信息 -->
            <div class="commentInfo" v-if="item.selfCommentContent != null">

                <div class="commentContent">我的评论: {{ item.selfCommentContent }}</div>
            </div>
...
function getData() {
    axiosInstance.get("/info/getCommentInfoByOthers", {
        headers: {
