  ...
  <AuthLayout>
    <div class="form-wrapper">
      ...
      <div class="input-items">
        ...
        <el-input v-model="confirmPassword" type="password" placeholder="请确认密码" prefix-icon="lock" show-password />
      </div>
      <div class="password-requirements">
        <p>密码必须包含:</p>
        <ul>
          <li :class="{ active: nameHasLength }">用户名至少四个字符</li>
...
// Password validation
const nameHasLength = computed(() => name.value.length >= 4)
...
function validate() {
  if (hasLength.value == true && hasUpper.value == true && hasLower.value == true && hasNumber.value == true && nameHasLength.value == true) {
    return true;
  } else {
    return false;
  }
